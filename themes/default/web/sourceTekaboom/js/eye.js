;(function() {
    ...
    //// Global Variables
    const face = document.querySelector("html");
    const pupils = face.querySelectorAll(".eye-pupil");
    ...
    Eye.prototype.setEyeCoordinates = function(mouseX, mouseY) {
      ...
      if(distance < distanceThreshold) {
        this.relativeX = mouseX - this.offsetX - r;
        this.relativeY = mouseY - this.offsetY - r;
      } 
      else {
  ...
  /* var eyeLeft = $('.eye-left'), eyePupilLeft = eyeLeft.find('div');
  var eyeRight = $('.eye-right'), eyePupilRight = eyeRight.find('div');
  eyeLeft.show();
  eyeRight.show();
  var x1 = eyeLeft.offset().left + 24, y1 = eyeLeft.offset().top + 24;
