    ...
    <div class="park-list__content fl fl-di-c fl-ju-co-sp-b">
        <div>
            ...
            <?php if($data->description_short) :?>
                <div class="park-list__desc t-stl"><?= $data->description_short; ?></div>
            <?php endif; ?>
        </div>
        <div class="park-list__but">
            <a class="park-list__link but-link but-link-white fl" href="<?= $url; ?>"><span>Подробнее</span></a>
        </div>
    </div>
