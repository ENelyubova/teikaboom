...
<fieldset>
    <div class="row">
		...
		<div class="col-sm-3">
            <?=  $form->textFieldGroup($model, 'theme_id', [
                'widgetOptions' => [
                    'htmlOptions' => [
                        'class' => 'popover-help',
                        'data-original-title' => $model->getAttributeLabel('theme_id'),
                        'data-content' => $model->getAttributeDescription('theme_id')
                    ]
                ]
            ]); ?>
        </div>
    ...
    <?php $this->widget(
        'bootstrap.widgets.TbButton', [
            ...
            'encodeLabel' => false,
            'buttonType'  => 'submit',
            'label'       => '<i class="fa fa-search">&nbsp;</i> ' . Yii::t('MasterclassModule.masterclass', 'Искать Мастер класс'),
        ]
    ); ?>
