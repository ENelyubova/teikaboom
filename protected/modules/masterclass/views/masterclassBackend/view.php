...
$this->pageTitle = Yii::t('MasterclassModule.masterclass', 'Мастер классы - просмотр');
...
<div class="page-header">
    <h1>
        <?=  Yii::t('MasterclassModule.masterclass', 'Просмотр') . ' ' . Yii::t('MasterclassModule.masterclass', 'Мастер класса'); ?>        <br/>
