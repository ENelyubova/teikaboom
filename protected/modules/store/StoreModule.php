...
class StoreModule extends WebModule
{
    ...
    public function getEditableParams()
    {
        return [
            ...
            'mostInteresting',
            'newId' => $this->getCategories(),
            'stockId' => $this->getCategories(),
            'saleId' => $this->getCategories(),
        ];
    }
    ...
    public function getParamsLabels()
    {
        return [
            ...
            'mostInteresting' => Yii::t('StoreModule.store', 'Самое интересное (id категорий)'),
            'newId' => Yii::t('StoreModule.store', 'Новинки'),
            'stockId' => Yii::t('StoreModule.store', 'Акции'),
            'saleId' => Yii::t('StoreModule.store', 'Распродажа'),
        ];
    }
    ...
    public function getNavigation()
    {
        return [
            [
                ...
                'label' => Yii::t('StoreModule.store', 'Badge'),
                'url' => ['/store/badgeBackend/index'],
            ],
            [
                'icon' => 'fa fa-fw fa-reorder',
