...
class NewsModule extends WebModule
{
    ...
    public function getParamsLabels()
    {
        return [
            ...
            'newsId' => Yii::t('NewsModule.news', 'Новости'),
            // 'stockId' => Yii::t('NewsModule.news', 'Акции'),
        ];
    }
    ...
    public function getEditableParamsGroups()
    {
        return [
            '0.main' => [
                'label' => Yii::t('NewsModule.news', 'Категории'),
                'items' => [
                    'newsId',
                    // 'stockId',
                ],
    ...
    public function getNavigation()
    {
        return [
            [
                ...
                'url' => ['/news/newsCategoryBackend/index'],
                // 'url' => [
    ...
    {
        return CHtml::listData(NewsCategory::model()->findAll(), 'id', 'name');
    }
}
