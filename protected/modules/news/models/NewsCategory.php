 ...
 */
class NewsCategory extends yupe\models\YModel
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('name_short, name, slug, image, icon', 'length', 'max'=>255),
			array('title, meta_title', 'length', 'max'=>250),
			['slug', 'yupe\components\validators\YSLugValidator'],
			array('description, meta_keywords, meta_description', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, create_user_id, update_user_id, create_time, update_time, name_short, name, slug, description, image, icon, title, meta_title, meta_keywords, meta_description, status, position', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'news' => [self::HAS_MANY, 'News', 'category_id'],
		);
	}
