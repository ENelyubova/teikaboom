...
class News extends yupe\models\YModel
{
    ...
    public function rules()
    {
        return [
            ...
            ['status, is_protected, category_id, park_id', 'numerical', 'integerOnly' => true],
            ...
            ['meta_title, meta_keywords, meta_description, type_news', 'length', 'max' => 250],
            ['link', 'length', 'max' => 250],
            ...
            ['type_news, data', 'safe'],
            [
                'id, meta_title, meta_keywords, meta_description, create_time, update_time, date, title, slug, short_text, full_text, user_id, status, is_protected, lang, park_id, type_news',
                'safe',
                'on' => 'search'
            ],
        ];
    ...
    public function relations()
    {
        return [
            ...
            'photos' => [self::HAS_MANY, 'NewsImage', 'news_id'],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'park_id' => Yii::t('NewsModule.news', 'ТРЦ'),
            'type_news' => Yii::t('NewsModule.news', 'Тип события'),
        ];
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('t.park_id', $this->park_id);
