<?php
/**
* Класс NewsCategoryBackendController:
*
...
*   @link     https://yupe.ru
**/
class NewsCategoryBackendController extends \yupe\components\controllers\BackController
{
    ...
    */
    public function actionCreate()
    {
        ...
        if (Yii::app()->getRequest()->getPost('NewsCategory') !== null) {
            $model->setAttributes(Yii::app()->getRequest()->getPost('NewsCategory'));
        
            if ($model->save()) {
                Yii::app()->user->setFlash(
                    yupe\widgets\YFlashMessages::SUCCESS_MESSAGE,
                    Yii::t('NewsModule.news', 'Запись добавлена!')
                );
    ...
    public function actionUpdate($id)
    {
        ...
        if (Yii::app()->getRequest()->getPost('NewsCategory') !== null) {
            ...
            if ($model->save()) {
                Yii::app()->user->setFlash(
                    yupe\widgets\YFlashMessages::SUCCESS_MESSAGE,
                    Yii::t('NewsModule.news', 'Запись обновлена!')
                );
    ...
    */
    public function actionDelete($id)
    {
        if (Yii::app()->getRequest()->getIsPostRequest()) {
            ...
            Yii::app()->user->setFlash(
                yupe\widgets\YFlashMessages::SUCCESS_MESSAGE,
                Yii::t('NewsModule.news', 'Запись удалена!')
            );
    ...
    */
    public function actionIndex()
    {
        ...
        if (Yii::app()->getRequest()->getParam('NewsCategory') !== null)
            $model->setAttributes(Yii::app()->getRequest()->getParam('NewsCategory'));
