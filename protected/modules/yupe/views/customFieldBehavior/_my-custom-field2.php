            ...
            <div class="myfield-template hidden form-group js-myfield">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        ...
                        <?= CHtml::dropDownList('', '', $customfieldGroup->getGroupList($module),
                            [
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <?= CHtml::dropDownList('MyCustomField['.$key.'][group]', $data['group'], $customfieldGroup->getGroupList($module),
                                                    [
                                                        'empty' => '--выберите группу--',
                                                        'class' => 'form-control myfield-group-dropdown',
                                                        'data-key' => $key
                ...
                <div class="row">
                    ...
                    <?php $this->widget(
                        ...
                        [
                            ...
                            'ajaxUrl' => Yii::app()->createUrl('/yupe/customfieldGroupBackend/index'),
