                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-11 col-sm-11">
                                                        <div class="js-template-field" style="padding: 20px 0 5px">
                                                            <code>
                                                                Скопируйте этот код для вставки таблицы: [[w:CustomField|module=<?= $module; ?>;id=<?= $model->id; ?>;code=<?= $data['code']; ?>;view=table-field]]
                                                            </code>
                                                        </div>
                                                        <div></div>
                                                        <label for="">Значение</label>
