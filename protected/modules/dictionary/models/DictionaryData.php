...
class DictionaryData extends yupe\models\YModel
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            ['code', 'length', 'max' => 100],
            ['name, value, description, image', 'length', 'max' => 250],
            ...
            [
                'id, group_id, code, name, description, create_time, update_time, create_user_id, update_user_id, status, image',
                'safe',
                'on' => 'search'
            ],
        ];
    ...
    {
        $module = Yii::app()->getModule('dictionary');
    ...
    public function attributeLabels()
    {
        return [
            ...
            'image'          => Yii::t('DictionaryModule.dictionary', 'Изображения'),
        ];
    }
