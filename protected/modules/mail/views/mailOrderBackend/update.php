...
$this->breadcrumbs = [
    ...
    $model->name => ['/mail/mailOrderBackend/view', 'id' => $model->id],
    Yii::t('MailModule.mail', 'Редактирование'),
];

$this->pageTitle = Yii::t('MailModule.mail', 'Заявки - редактирование');
...
<div class="page-header">
    <h1>
        <?=  Yii::t('MailModule.mail', 'Редактирование') . ' ' . Yii::t('MailModule.mail', 'Заявки'); ?>        <br/>
