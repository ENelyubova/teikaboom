...
class ContentBlock extends yupe\models\YModel
{
    ...
    public function rules()
    {
        return [
            ...
            ['name', 'length', 'max' => 250],
            ['code', 'length', 'max' => 100],
            ['description, image', 'length', 'max' => 255],
            [
                'code',
            ...
            ['code', 'unique'],
            ['id, name, code, type, content, description, category_id, status, image', 'safe', 'on' => 'search'],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'image' => Yii::t('ContentBlockModule.contentblock', 'Изображение'),
        ];
    }
    ...
    public function search()
    {
        ...
        $criteria->compare($this->tableAlias . '.image', $this->image);
