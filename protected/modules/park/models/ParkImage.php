 ...
 */
class ParkImage extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('park_id, position', 'numerical', 'integerOnly'=>true),
			array('image, title, alt, description', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, park_id, image, title, alt, description, position', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'park' => array(self::BELONGS_TO, 'Park', 'park_id'),
		);
	}
