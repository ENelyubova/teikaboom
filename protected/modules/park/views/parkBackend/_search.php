...
<fieldset>
    <div class="row">
		...
		<div class="col-sm-3">
            <?=  $form->textAreaGroup($model, 'subway_station', [
            'widgetOptions' => [
                'htmlOptions' => [
                    'class' => 'popover-help',
                    'rows' => 6,
                    'cols' => 50,
                    'data-original-title' => $model->getAttributeLabel('subway_station'),
		...
		<div class="col-sm-3">
            ...
            'widgetOptions' => [
                'htmlOptions' => [
                    ...
                    'rows' => 6,
                    'cols' => 50,
                    'data-original-title' => $model->getAttributeLabel('how_to_get'),
                    'data-content' => $model->getAttributeDescription('how_to_get')
                ]
            ]]); ?>
        </div>
		<div class="col-sm-3">
            <?=  $form->textAreaGroup($model, 'back', [
            'widgetOptions' => [
                'htmlOptions' => [
                    'class' => 'popover-help',
                    'rows' => 6,
    ...
    <?php $this->widget(
        'bootstrap.widgets.TbButton', [
            ...
            'encodeLabel' => false,
            'buttonType'  => 'submit',
            'label'       => '<i class="fa fa-search">&nbsp;</i> ' . Yii::t('ParkModule.park', 'Искать Парк'),
        ]
    ); ?>
